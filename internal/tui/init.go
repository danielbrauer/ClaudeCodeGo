...
// initPrompt is the prompt sent to the agentic loop when the user runs /init.
// It asks Claude to analyze the codebase and create or improve a CLAUDE.md file.
